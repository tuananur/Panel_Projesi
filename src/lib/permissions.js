...
export const PERMISSION_GROUPS = [
  {
    ...
    items: [
      ...
      { key: 'page.notifications', label: 'Bildirimlerim' },
      { key: 'page.send_notifications', label: 'Bildirim Gönder' },
      { key: 'page.reports', label: 'Raporlar' },
      { key: 'page.oto_blog', label: 'Oto Blog' },
    ],
  },
  {
    ...
    items: [
      ...
      { key: 'client.tab.analytics', label: 'Google Analytics' },
