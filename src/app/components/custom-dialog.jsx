...
export default function CustomDialog({ isOpen, title, children, onClose, onConfirm, confirmText = 'Tamam', cancelText = 'İptal', loading = false, showCancel = true, showButtons = true }) {
