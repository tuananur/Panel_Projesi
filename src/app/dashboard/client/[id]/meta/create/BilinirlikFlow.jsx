        ...
        {formData.purchaseType !== 'Rezervasyon' && (
          ...
          <>
            ...
            <div style={{ background: 'var(--bg-secondary)', borderRadius: '8px', padding: '1.5rem', border: '1px solid var(--border-color)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                <CheckCircle2 size={20} color="#10b981" />
                <h3 style={{ margin: 0, fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 600 }}>Reklam Seti Adı</h3>
              </div>
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                <input 
                  ...
                  style={{ flex: 1, padding: '0.8rem', border: '1px solid var(--border-color)', borderRadius: '6px', fontSize: '0.95rem', color: 'var(--text-primary)', outline: 'none' }}
                  placeholder="Yeni Bilinirlik Reklam Seti"
                />
              </div>
            </div>
            ...
            <div style={{ background: 'var(--bg-secondary)', borderRadius: '8px', padding: '1.5rem', border: '1px solid var(--border-color)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                <CheckCircle2 size={20} color="#10b981" />
                <h3 style={{ margin: 0, fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 600 }}>Performans Hedefi</h3>
              </div>
              <p style={{ margin: '0 0 1rem 0', fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.4' }}>Reklam setiniz için ölçülebilir bir hedef belirleyin. <span style={{ color: '#1877f2', cursor: 'pointer' }}>Daha fazla bilgi alın</span></p>
              
              <label style={{ fontSize: '0.85rem', color: 'var(--text-primary)', display: 'block', marginBottom: '0.4rem', fontWeight: 700 }}>Performans hedefi <HelpCircle size={12}/></label>
              <select style={{ width: '100%', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', color: 'var(--text-primary)', padding: '0.65rem 0.85rem', borderRadius: '6px', fontSize: '0.85rem', outline: 'none', appearance: 'none' }}>
                <option>Erişimi maksimize et</option>
                <option>Reklam hatırlanabilirliği artışını maksimize et</option>
                <option>Görüntülemeleri maksimize et</option>
              </select>
            </div>
            ...
            <div style={{ background: 'var(--bg-secondary)', borderRadius: '8px', padding: '1.5rem', border: '1px solid var(--border-color)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                <CheckCircle2 size={20} color="#10b981" />
                <h3 style={{ margin: 0, fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 600 }}>Bütçe ve Plan</h3>
              </div>
              
              <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem' }}>
                <div style={{ flex: 1 }}>
                  <label style={{ fontSize: '0.85rem', color: 'var(--text-primary)', display: 'block', marginBottom: '0.4rem', fontWeight: 700 }}>Bütçe</label>
                  <select 
                    value={formData.budgetType}
                    onChange={e => setFormData({...formData, budgetType: e.target.value})}
                    style={{ width: '100%', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', color: 'var(--text-primary)', padding: '0.65rem', borderRadius: '4px', fontSize: '0.85rem' }}
                  >
                    <option>Günlük Bütçe</option>
                    <option>Toplam bütçe</option>
                  </select>
                ...
                <div style={{ flex: 1 }}>
                  <label style={{ fontSize: '0.85rem', color: 'var(--text-primary)', display: 'block', marginBottom: '0.4rem', fontWeight: 700 }}>Tutar</label>
                  <div style={{ position: 'relative' }}>
                    <input type="number" defaultValue={50} style={{ width: '100%', background: 'var(--bg-secondary)', border: '1px solid #1877f2', color: 'var(--text-primary)', padding: '0.65rem', borderRadius: '4px', fontSize: '0.85rem', textAlign: 'right', paddingRight: '2.5rem' }} />
              ...
              {formData.budgetType === 'Günlük Bütçe' && (
                <div style={{ marginBottom: '1.5rem' }}>
                  <div style={{ color: '#1877f2', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer', marginBottom: '0.8rem' }} onClick={() => setFormData({ ...formData, hideOptionsAdsetLimit: !formData.hideOptionsAdsetLimit })}>
                    {formData.hideOptionsAdsetLimit ? 'Seçenekleri Göster ▾' : 'Seçenekleri Gizle ▴'}
                  </div>
                  {!formData.hideOptionsAdsetLimit && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', marginTop: '0.5rem' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div style={{ fontSize: '0.8rem', fontWeight: 700, color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '4px' }}>Reklam Seti Harcama Sınırı <span style={{ color: 'var(--text-secondary)', fontWeight: 'normal' }}>· İsteğe bağlı</span></div>
                        {formData.adsetSpendingLimitEdit ? (
                          <div style={{ color: '#1877f2', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }} onClick={() => setFormData({...formData, adsetSpendingLimitEdit: false})}>İptal</div>
                        ) : (
                          <div style={{ color: '#1877f2', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }} onClick={() => setFormData({...formData, adsetSpendingLimitEdit: true})}><Pencil size={12}/> Düzenle</div>
                        )}
                      </div>
                      
                      {!formData.adsetSpendingLimitEdit ? (
                        <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
                          {formData.adsetSpendingLimitAmount ? `Günlük ${formData.adsetSpendingLimitAmount} TL` : 'Hiçbiri eklenmedi'}
                        </div>
                      ) : (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', background: 'var(--bg-primary)', padding: '1rem', borderRadius: '6px', border: '1px solid var(--border-color)' }}>
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
                            <input type="checkbox" checked={formData.adsetSpendingLimitEnabled || false} onChange={e => setFormData({...formData, adsetSpendingLimitEnabled: e.target.checked})} style={{ marginTop: '0.2rem' }} />
                            <div>
                              <div style={{ fontSize: '0.85rem', color: 'var(--text-primary)', fontWeight: 600 }}>Reklam Seti Harcama Sınırı Ekle</div>
                              <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', marginTop: '0.2rem' }}>Reklam setiniz için minimum veya maksimum günlük harcama sınırı belirleyin.</div>
                            </div>
                          </div>
                          {formData.adsetSpendingLimitEnabled && (
                            <div style={{ position: 'relative', width: '200px' }}>
                              <span style={{ position: 'absolute', left: '0.8rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-primary)', fontWeight: 600 }}>₺</span>
                              <input type="number" placeholder="Ayarlı Sınır Yok" value={formData.adsetSpendingLimitAmount || ''} onChange={e => setFormData({...formData, adsetSpendingLimitAmount: e.target.value})} style={{ width: '100%', padding: '0.6rem 0.6rem 0.6rem 2rem', background: 'var(--bg-secondary)', border: '1px solid #1877f2', borderRadius: '4px', color: 'var(--text-primary)', outline: 'none' }} />
                            </div>
                          )}
                        </div>
                      )}
              ...
              <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  <div>
                    <label style={{ fontSize: '0.85rem', color: 'var(--text-primary)', display: 'block', marginBottom: '0.4rem', fontWeight: 600 }}>Başlangıç Tarihi</label>
                    <input type="date" defaultValue="2026-06-15" style={{ width: '100%', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', color: 'var(--text-primary)', padding: '0.65rem', borderRadius: '4px', fontSize: '0.85rem' }} />
                  </div>
                  <div>
                    <label style={{ fontSize: '0.85rem', color: 'var(--text-primary)', display: 'block', marginBottom: '0.4rem', fontWeight: 600 }}>Bitiş Tarihi</label>
            ...
            <div style={{ background: 'var(--bg-secondary)', borderRadius: '8px', padding: '1.5rem', border: '1px solid var(--border-color)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                <CheckCircle2 size={20} color="#10b981" />
                <h3 style={{ margin: 0, fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 600 }}>Hedef Kitle</h3>
              </div>
              <div style={{ display: 'flex', gap: '1rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.5rem', marginBottom: '1rem' }}>
                <div style={{ color: '#1877f2', fontWeight: 600, fontSize: '0.9rem', cursor: 'pointer', borderBottom: '2px solid #1877f2', paddingBottom: '0.5rem' }}>Yeni hedef kitle oluştur</div>
                <div style={{ color: 'var(--text-secondary)', fontWeight: 600, fontSize: '0.9rem', cursor: 'pointer' }}>Kaydedilen hedef kitleyi kullan</div>
              </div>
              <label style={{ fontSize: '0.85rem', color: 'var(--text-primary)', display: 'block', marginBottom: '0.4rem', fontWeight: 700 }}>Özel Hedef Kitleler</label>
              <input placeholder="Mevcut hedef kitleleri arayın" style={{ width: '100%', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', color: 'var(--text-primary)', padding: '0.8rem', borderRadius: '6px', fontSize: '0.85rem', outline: 'none' }} />
            </div>
            ...
            <div style={{ background: 'var(--bg-secondary)', borderRadius: '8px', padding: '1.5rem', border: '1px solid var(--border-color)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                <CheckCircle2 size={20} color="#10b981" />
                <h3 style={{ margin: 0, fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 600 }}>Yerleşimler</h3>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '1rem', border: '1px solid #1877f2', background: 'rgba(24,119,242,0.05)', borderRadius: '8px', cursor: 'pointer' }}>
                <input type="radio" checked readOnly style={{ width: '18px', height: '18px', accentColor: '#1877f2' }} />
                <div>
                  <div style={{ fontWeight: 600, color: 'var(--text-primary)', fontSize: '0.9rem' }}>Advantage+ yerleşimler (Önerilen)</div>
                  <div style={{ color: 'var(--text-secondary)', fontSize: '0.8rem', marginTop: '0.2rem' }}>Performansınızı maksimize etmek için bütçenizi en iyi yerleşimlere dağıtırız.</div>
                </div>
              </div>
            </div>
          </>
