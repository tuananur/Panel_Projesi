...
import TrafficCustomFlow from './TrafficCustomFlow';
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '0.8rem', alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              <button type="button" onClick={() => router.push('/reauth')} style={{ background: '#1877f2', color: '#fff', border: 'none', padding: '0.5rem 1rem', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 600, cursor: 'pointer' }}>Kimliği Onayla</button>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: activeTab === 'ads' || (activeTab === 'campaigns' && selectedObjective === 'Bilinirlik') ? '1fr' : 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', flex: 1, padding: '1.5rem 2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {selectedObjective === 'Trafik' && trafficSetupType === 'custom' ? (
               <TrafficCustomFlow onBack={() => { setSelectedObjective(null); setShowObjectiveModal(true); }} />
            ) : selectedObjective ? (
            ...
            {activeTab === 'adsets' && selectedObjective !== 'Bilinirlik' && renderAdsetFormFields(createFormData, setCreateFormData, true, true)}
