...
export default function ClientNav({ clientId, canSeeStats = true, canSeeNotes = true, canSeeDev = false, canSeeSEO, canSeeSocial, canSeeSettings, canSeeMeta, canSeeGoogle }) {
