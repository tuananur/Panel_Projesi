...
export const GENERAL_REPORT_SECTIONS = [
  ...
  { no: 6, title: 'Google Arama Genel Performans' },
  { no: 7, title: 'Google Arama Günlük Performans' },
  { no: 8, title: 'Google Arama Sorguları' },
  { no: 9, title: 'SEO Anahtar Kelime Performansı' },
  { no: 10, title: 'Takip Edilen Anahtar Kelimeler' },
  { no: 11, title: 'Sıralaması Yükselen Kelimeler' },
  { no: 12, title: 'Sıralaması Düşen Kelimeler' },
  { no: 13, title: 'SEO Fırsat Anahtar Kelimeleri' },
  { no: 14, title: 'CTR (tıklama oranı) Fırsatları' },
  { no: 15, title: 'Organik Aramadan İlk Girilen Sayfalar' },
  { no: 16, title: 'En Çok Organik Trafik Getiren Sayfalar' },
  { no: 17, title: 'Sitede En Çok Açılan Sayfalar' },
  { no: 18, title: 'Trafiği Artan / Azalan Sayfalar' },
  { no: 19, title: 'İlk Kez Gelen / Tekrar Gelen Kullanıcılar' },
  { no: 20, title: 'Tekrar Gelme / Cohort' },
  { no: 21, title: 'Cihaz Dağılımı' },
  { no: 22, title: 'Ülke Dağılımı' },
  { no: 23, title: 'Google Arama Ülke Performansı' },
  ...
  { no: 36, title: 'Yeni Link Veren / Linki Kesilen Siteler' },
